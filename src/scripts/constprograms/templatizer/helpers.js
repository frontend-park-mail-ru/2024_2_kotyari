 ...
 *
 * Экспортируемый массив `helps` содержит объекты с именем и ссылкой на функцию хелпера.
 * В данном случае, массив содержит хелпер для работы с множественными формами существительных.
 *
 * @example
 * // Пример использования:
 * helps.find(helper => helper.name === 'pluralize').function(5, 'товар', 'товара', 'товаров');
 *
 * @exports helpers
 */
